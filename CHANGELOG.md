...
- Bump Native SDK from v0.8.4 to v0.11.1 ([#34](https://github.com/lucas-zimerman/sentry-java/pull/34))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0111)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.8.4...0.11.1)
