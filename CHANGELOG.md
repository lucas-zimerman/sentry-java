...
- Bump Native SDK from v0.7.2 to v0.8.1 ([#19](https://github.com/lucas-zimerman/sentry-java/pull/19))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#081)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.7.2...0.8.1)
