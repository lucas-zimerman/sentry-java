...
- Bump Native SDK from v0.8.4 to v0.11.0 ([#33](https://github.com/lucas-zimerman/sentry-java/pull/33))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0110)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.8.4...0.11.0)
