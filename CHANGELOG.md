...
- Bump Native SDK from v0.8.4 to v0.12.0 ([#37](https://github.com/lucas-zimerman/sentry-java/pull/37))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0120)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.8.4...0.12.0)
