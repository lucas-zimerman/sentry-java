...
- Bump Native SDK from v0.8.4 to v0.11.2 ([#35](https://github.com/lucas-zimerman/sentry-java/pull/35))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0112)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.8.4...0.11.2)
